        ...
        <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-6">
          ...
          {done ? (
            <div className="space-y-4">
              ...
              <a href="/login" className="block text-center w-full py-2.5 rounded-xl bg-indigo-600 text-white text-sm font-bold hover:bg-indigo-700">Se connecter</a>
            </div>
          ) : !token ? (
            ...
            <form onSubmit={submit} className="space-y-4">
              ...
              <button type="submit" disabled={loading} className="w-full py-2.5 rounded-xl bg-indigo-600 text-white text-sm font-bold hover:bg-indigo-700 disabled:opacity-50">
