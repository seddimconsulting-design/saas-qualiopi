/* Bibliothèque de modèles de documents conformes Qualiopi.
   Chaque modèle est rattaché à un indicateur RNQ. Contenu générique à personnaliser
   par l'organisme de formation. A valider selon votre activité et l'arrêté RNQ V9. */
...
export const TEMPLATES = [
  {
    id: 'convention', indicator: 25, title: 'Convention de formation professionnelle',
  ...
  {
    id: 'reglement-interieur', indicator: 9, title: 'Règlement intérieur',
  ...
  {
    id: 'programme', indicator: 5, title: 'Programme de formation',
  ...
  },
  {
    ...
    sections: [
      ...
      { h: 'Formateur', body: "Nom du formateur : …………………………  Signature : ……………" },
    ],
  },
  {
  ...
  {
    id: 'satisfaction-chaud', indicator: 13, title: 'Questionnaire de satisfaction à chaud',
  ...
  {
    id: 'satisfaction-froid', indicator: 14, title: 'Questionnaire d\'évaluation à froid (J+90)',
  ...
  {
    id: 'procedure-reclamation', indicator: 30, title: 'Procédure de traitement des réclamations',
  ...
  {
    id: 'fiche-non-conformite', indicator: 31, title: 'Fiche de non-conformité et action corrective',
  ...
  {
    id: 'sous-traitance', indicator: 22, title: 'Contrat-cadre de sous-traitance pédagogique',
  ...
  {
    id: 'referent-handicap', indicator: 4, title: 'Fiche référent handicap et procédure d\'accessibilité',
